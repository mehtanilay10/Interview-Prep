...
## Section 1. Querying data [#](https://www.sqlservertutorial.net/sql-server-basics/#querying-data "Anchor for Section 1. Querying data")
...
-   [SELECT](https://www.sqlservertutorial.net/sql-server-basics/sql-server-select/) – show you how to query data against a single table.

## Section 2. Sorting data [#](https://www.sqlservertutorial.net/sql-server-basics/#sorting-data "Anchor for Section 2. Sorting data")

-   [ORDER BY](https://www.sqlservertutorial.net/sql-server-basics/sql-server-order-by/) – sort the result set based on values in a specified list of columns

## Section 3. Limiting rows [#](https://www.sqlservertutorial.net/sql-server-basics/#limiting-rows "Anchor for Section 3. Limiting rows")

-   [OFFSET FETCH](https://www.sqlservertutorial.net/sql-server-basics/sql-server-offset-fetch/) – limit the number of rows returned by a query.

-   [SELECT TOP](https://www.sqlservertutorial.net/sql-server-basics/sql-server-select-top/) – limit the number of rows or percentage of rows returned in a query’s result set.

## Section 4. Filtering data [#](https://www.sqlservertutorial.net/sql-server-basics/#filtering-data "Anchor for Section 4. Filtering data")
...
-   [OR](https://www.sqlservertutorial.net/sql-server-basics/sql-server-or/)–  combine two Boolean expressions and return true if either of the conditions is true.
...
-   [Column & table aliases](https://www.sqlservertutorial.net/sql-server-basics/sql-server-alias/) – show you how to use column aliases to change the heading of the query output and table aliases to improve the readability of a query.

## Section 5. Joining tables [#](https://www.sqlservertutorial.net/sql-server-basics/#joining-tables "Anchor for Section 5. Joining tables")
...
-   [LEFT JOIN](https://www.sqlservertutorial.net/sql-server-basics/sql-server-left-join/) – return all rows from the left table and matching rows from the right table. If the right table does not have corresponding rows, use NULL for the column values from the right table.
...
## Section 6. Grouping data [#](https://www.sqlservertutorial.net/sql-server-basics/#grouping-data "Anchor for Section 6. Grouping data")
...
##  Section 7. Subquery [#](https://www.sqlservertutorial.net/sql-server-basics/#section-7-subquery "Anchor for  Section 7. Subquery")

This section covers subqueries, which are queries nested within another statement, such as SELECT, INSERT, UPDATE, or DELETE.

-   [Subquery](https://www.sqlservertutorial.net/sql-server-basics/sql-server-subquery/) – explain the subquery concept and show you how to use various subquery types to select data.
...
-   [ANY](https://www.sqlservertutorial.net/sql-server-basics/sql-server-any/) – compare a value with a single-column set of values returned by a subquery and return TRUE if the value matches any value in the set.
-   [ALL](https://www.sqlservertutorial.net/sql-server-basics/sql-server-all/) – compare a value with a single-column set of values returned by a subquery and return TRUE if the value matches all values in the set.

-   [CROSS APPLY](https://www.sqlservertutorial.net/sql-server-basics/sql-server-cross-apply/) – perform an inner join of a table with a table-valued function or a correlated subquery.
-   [OUTER APPLY](https://www.sqlservertutorial.net/sql-server-basics/sql-server-outer-apply/) – perform a left join of a table with a table-valued function or a correlated subquery.

## Section 8. Set Operators [#](https://www.sqlservertutorial.net/sql-server-basics/#set-operators "Anchor for Section 8. Set Operators")
...
## Section 9. Common Table Expression (CTE) [#](https://www.sqlservertutorial.net/sql-server-basics/#common-table-expression-cte "Anchor for Section 9. Common Table Expression (CTE)")

-   [CTE](https://www.sqlservertutorial.net/sql-server-basics/sql-server-cte/) – use common table expressions to make complex queries more readable.
...
## Section 10. Pivot [#](https://www.sqlservertutorial.net/sql-server-basics/#pivot "Anchor for Section 10. Pivot")

-   [PIVOT](https://www.sqlservertutorial.net/sql-server-basics/sql-server-pivot/) – convert rows to columns

## Section 11. Modifying data [#](https://www.sqlservertutorial.net/sql-server-basics/#modifying-data "Anchor for Section 11. Modifying data")
...
-   [INSERT INTO SELECT](https://www.sqlservertutorial.net/sql-server-basics/sql-server-insert-into-select/) – insert data that comes from the result set of a query into a table.
...
-   [Transaction](https://www.sqlservertutorial.net/sql-server-basics/sql-server-transaction/) – show you how to start a transaction explicitly using the BEGIN TRANSACTION, COMMIT, and ROLLBACK statements

## Section 12. Data definition [#](https://www.sqlservertutorial.net/sql-server-basics/#data-definition "Anchor for Section 12. Data definition")

This section shows you how to manage the most important database objects including databases and tables.

-   [CREATE DATABASE](https://www.sqlservertutorial.net/sql-server-basics/sql-server-create-database/) – show you how to create a new database in an SQL Server instance using the CREATE DATABASE statement and SQL Server Management Studio.
...
-   [ALTER SCHEMA](https://www.sqlservertutorial.net/sql-server-basics/sql-server-alter-schema/) – show how to transfer a securable from one schema to another within the same database.
...
-   [Computed columns](https://www.sqlservertutorial.net/sql-server-basics/sql-server-computed-columns/) – how to use the computed columns to reuse the calculation logic in multiple queries.
...
-   [Temporary tables](https://www.sqlservertutorial.net/sql-server-basics/sql-server-temporary-tables/) – introduce you to the temporary tables for storing temporary immediate data in stored procedures or database sessions.

-   [Synonym](https://www.sqlservertutorial.net/sql-server-basics/sql-server-synonym/) – explain the synonym and show you how to create synonyms for database objects.

## Section 13. SQL Server Data Types [#](https://www.sqlservertutorial.net/sql-server-basics/#sql-server-data-types "Anchor for Section 13. SQL Server Data Types")
...
-   [CHAR](https://www.sqlservertutorial.net/sql-server-basics/sql-server-char/) – learn how to store fixed-length, non-Unicode character strings in the database.

-   [NCHAR](https://www.sqlservertutorial.net/sql-server-basics/sql-server-nchar/) –  show you how to store fixed-length, Unicode character strings and explains the differences between `CHAR` and `NCHAR` data types
...
## Section 14. Constraints [#](https://www.sqlservertutorial.net/sql-server-basics/#constraints "Anchor for Section 14. Constraints")

-   [Primary key](https://www.sqlservertutorial.net/sql-server-basics/sql-server-primary-key/)  – explain the primary key concept and show you how to use the primary key constraint to manage the primary key of a table.
...
-   [NOT NULL constraint](https://www.sqlservertutorial.net/sql-server-basics/sql-server-not-null-constraint/) – show you how to ensure a column does not accept NULL.
...
## Section 15. Expressions [#](https://www.sqlservertutorial.net/sql-server-basics/#expressions "Anchor for Section 15. Expressions")
...
## Section 16. Useful Tips [#](https://www.sqlservertutorial.net/sql-server-basics/#useful-tips "Anchor for Section 16. Useful Tips")
...
---
Source: [SQL Server Basics](https://www.sqlservertutorial.net/sql-server-basics/)