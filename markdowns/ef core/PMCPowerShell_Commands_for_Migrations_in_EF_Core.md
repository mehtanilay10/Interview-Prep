...
Migration commands in Entity Framework Core can be executed using the Package Manager Console in Visual Studio. Open the Package Manager Console from menu Tools -> NuGet Package Manager -> Package Manager Console in Visual Studio to execute the following commands.

| PMC Command | Usage |
| --- | --- |
| [Get-Help entityframework](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#get-help) | Displays information about entity framework commands. |
| [Add-Migration <migration name>](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#add-migration) | Creates a migration by adding a migration snapshot. |
| [Remove-Migration](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#remove-migration) | Removes the last migration snapshot. |
| [Update-Database](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#update-database) | Updates the database schema based on the last migration snapshot. |
| [Script-Migration](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#script-migration) | Generates a SQL script using all the migration snapshots. |
| [Scaffold-DbContext](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#scaffold-dbcontext) | Generates a DbContext and entity type classes for a specified database. This is called reverse engineering. |
| [Get-DbContext](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#get-dbcontext) | Gets information about a DbContext type. |
| [Drop-Database](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx#drop-database) | Drops the database. |
...
LONG DESCRIPTION
    ...
    See https://learn.microsoft.com/en-us/ef/ for information on Entity Framework Core.
...
---
Source: [PMC/PowerShell Commands for Migrations](https://www.entityframeworktutorial.net/efcore/pmc-commands-for-ef-core-migration.aspx)