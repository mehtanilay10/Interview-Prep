...
![TypeScript](https://raw.githubusercontent.com/rmolinamir/typescript-cheatsheet/master/TypeScript.png)
...
-   [TypeScript Cheatsheet](https://rmolinamir.github.io/typescript-cheatsheet/#typescript-cheatsheet)

-   [Table of contents](https://rmolinamir.github.io/typescript-cheatsheet/#table-of-contents)
    -   [Introduction](https://rmolinamir.github.io/typescript-cheatsheet/#introduction)
    -   [Types](https://rmolinamir.github.io/typescript-cheatsheet/#types)
        -   [Basic Assign Types](https://rmolinamir.github.io/typescript-cheatsheet/#basic-assign-types)
            -   [String](https://rmolinamir.github.io/typescript-cheatsheet/#string)
            -   [Number](https://rmolinamir.github.io/typescript-cheatsheet/#number)
            -   [Boolean](https://rmolinamir.github.io/typescript-cheatsheet/#boolean)
            -   [Array](https://rmolinamir.github.io/typescript-cheatsheet/#array)
        -   [Tuples](https://rmolinamir.github.io/typescript-cheatsheet/#tuples)
        -   [Any](https://rmolinamir.github.io/typescript-cheatsheet/#any)
        -   [Enums](https://rmolinamir.github.io/typescript-cheatsheet/#enums)
        -   [Functions](https://rmolinamir.github.io/typescript-cheatsheet/#functions)
        -   [Argument Types](https://rmolinamir.github.io/typescript-cheatsheet/#argument-types)
        -   [Function Types](https://rmolinamir.github.io/typescript-cheatsheet/#function-types)
        -   [Void Function Type](https://rmolinamir.github.io/typescript-cheatsheet/#void-function-type)
        -   [Objects](https://rmolinamir.github.io/typescript-cheatsheet/#objects)
            -   [Complex Objects](https://rmolinamir.github.io/typescript-cheatsheet/#complex-objects)
            -   [Optional object properties](https://rmolinamir.github.io/typescript-cheatsheet/#optional-object-properties)
        -   [Alias](https://rmolinamir.github.io/typescript-cheatsheet/#alias)
        -   [Union](https://rmolinamir.github.io/typescript-cheatsheet/#union)
        -   [Intersection](https://rmolinamir.github.io/typescript-cheatsheet/#intersection)
        -   [Check](https://rmolinamir.github.io/typescript-cheatsheet/#check)
        -   [Never](https://rmolinamir.github.io/typescript-cheatsheet/#never)
        -   [Nullable](https://rmolinamir.github.io/typescript-cheatsheet/#nullable)
        -   [Type Assertions](https://rmolinamir.github.io/typescript-cheatsheet/#type-assertions)
    -   [ES6](https://rmolinamir.github.io/typescript-cheatsheet/#es6)
        -   [Template Literals](https://rmolinamir.github.io/typescript-cheatsheet/#template-literals)
        -   [Arrow Functions](https://rmolinamir.github.io/typescript-cheatsheet/#arrow-functions)
        -   [Default Parameters](https://rmolinamir.github.io/typescript-cheatsheet/#default-parameters)
        -   [Spread Operators](https://rmolinamir.github.io/typescript-cheatsheet/#spread-operators)
        -   [Array Destructuring](https://rmolinamir.github.io/typescript-cheatsheet/#array-destructuring)
        -   [Object Destructuring](https://rmolinamir.github.io/typescript-cheatsheet/#object-destructuring)
    -   [Classes](https://rmolinamir.github.io/typescript-cheatsheet/#classes)
    -   [Private Members](https://rmolinamir.github.io/typescript-cheatsheet/#private-members)
    -   [Class Inheritance](https://rmolinamir.github.io/typescript-cheatsheet/#class-inheritance)
    -   [Getters & Setters](https://rmolinamir.github.io/typescript-cheatsheet/#getters--setters)
    -   [Static Properties & Methods](https://rmolinamir.github.io/typescript-cheatsheet/#static-properties--methods)
    -   [Abstract Classes](https://rmolinamir.github.io/typescript-cheatsheet/#abstract-classes)
    -   [Private Constructors & Singletons](https://rmolinamir.github.io/typescript-cheatsheet/#private-constructors--singletons)
    -   [Modules](https://rmolinamir.github.io/typescript-cheatsheet/#modules)
        -   [Export](https://rmolinamir.github.io/typescript-cheatsheet/#export)
        -   [Default Exports](https://rmolinamir.github.io/typescript-cheatsheet/#default-exports)
        -   [Import](https://rmolinamir.github.io/typescript-cheatsheet/#import)
        -   [Advanced Module Loading](https://rmolinamir.github.io/typescript-cheatsheet/#advanced-module-loading)
    -   [Namespaces](https://rmolinamir.github.io/typescript-cheatsheet/#namespaces)
    -   [Ambient Modules](https://rmolinamir.github.io/typescript-cheatsheet/#ambient-modules)
        -   [Manually declaring a third party library](https://rmolinamir.github.io/typescript-cheatsheet/#manually-declaring-a-third-party-library)
        -   [Using @types/\[third-party-library\] NPM packages](https://rmolinamir.github.io/typescript-cheatsheet/#using-typesthird-party-library-npm-packages)
        -   [Shorthand for Ambient Modules](https://rmolinamir.github.io/typescript-cheatsheet/#shorthand-for-ambient-modules)
        -   [Wildcard module declarations](https://rmolinamir.github.io/typescript-cheatsheet/#wildcard-module-declarations)
        -   [UMD modules](https://rmolinamir.github.io/typescript-cheatsheet/#umd-modules)
    -   [Interfaces](https://rmolinamir.github.io/typescript-cheatsheet/#interfaces)
        -   [Optional Properties](https://rmolinamir.github.io/typescript-cheatsheet/#optional-properties)
        -   [Index Signatures (Dynamic Property Names)](https://rmolinamir.github.io/typescript-cheatsheet/#index-signatures-dynamic-property-names)
        -   [Implements Keyword](https://rmolinamir.github.io/typescript-cheatsheet/#implements-keyword)
            -   [*1.* Implementing an `interface` to a `Class`](https://rmolinamir.github.io/typescript-cheatsheet/#1-implementing-an-interface-to-a-class)
            -   [*2.* Implementing an `interface` to a `function`](https://rmolinamir.github.io/typescript-cheatsheet/#2-implementing-an-interface-to-a-function)
        -   [Extends Keyword (Interface Inheritance)](https://rmolinamir.github.io/typescript-cheatsheet/#extends-keyword-interface-inheritance)
    -   [`Omit` type when extending an interface](https://rmolinamir.github.io/typescript-cheatsheet/#omit-type-when-extending-an-interface)
    -   [Omitting specific properties when extending an interface](https://rmolinamir.github.io/typescript-cheatsheet/#omitting-specific-properties-when-extending-an-interface)
    -   [Type checking for interfaces](https://rmolinamir.github.io/typescript-cheatsheet/#type-checking-for-interfaces)
    -   [Generics](https://rmolinamir.github.io/typescript-cheatsheet/#generics)
        -   [Simple Generics](https://rmolinamir.github.io/typescript-cheatsheet/#simple-generics)
        -   [Better Generics](https://rmolinamir.github.io/typescript-cheatsheet/#better-generics)
        -   [Built-in Generics](https://rmolinamir.github.io/typescript-cheatsheet/#built-in-generics)
        -   [Generic Types](https://rmolinamir.github.io/typescript-cheatsheet/#generic-types)
        -   [Generic Class](https://rmolinamir.github.io/typescript-cheatsheet/#generic-class)
    -   [Decorators](https://rmolinamir.github.io/typescript-cheatsheet/#decorators)
        -   [Prologue](https://rmolinamir.github.io/typescript-cheatsheet/#prologue)
        -   [Decorators Introduction](https://rmolinamir.github.io/typescript-cheatsheet/#decorators-introduction)
        -   [Basic Decorator](https://rmolinamir.github.io/typescript-cheatsheet/#basic-decorator)
        -   [Factory](https://rmolinamir.github.io/typescript-cheatsheet/#factory)
        -   [Advanced Decorator](https://rmolinamir.github.io/typescript-cheatsheet/#advanced-decorator)
        -   [Method Decorator](https://rmolinamir.github.io/typescript-cheatsheet/#method-decorator)
        -   [Property Decorator](https://rmolinamir.github.io/typescript-cheatsheet/#property-decorator)
        -   [Parameter Decorator](https://rmolinamir.github.io/typescript-cheatsheet/#parameter-decorator)
    -   [Webpack Workflow (v^4.X)](https://rmolinamir.github.io/typescript-cheatsheet/#webpack-workflow-v4x)
    -   [TypeScript with React.js](https://rmolinamir.github.io/typescript-cheatsheet/#typescript-with-reactjs)
        -   [TypeScript while using `create-react-app`](https://rmolinamir.github.io/typescript-cheatsheet/#typescript-while-using-create-react-app)
    -   [Setting up general React prop types](https://rmolinamir.github.io/typescript-cheatsheet/#setting-up-general-react-prop-types)
        -   [References (`React.createRef()` or `useRef` API)](https://rmolinamir.github.io/typescript-cheatsheet/#references-reactcreateref-or-useref-api)
        -   [React Children](https://rmolinamir.github.io/typescript-cheatsheet/#react-children)
        -   [CSS Properties and Classes Prop Types](https://rmolinamir.github.io/typescript-cheatsheet/#css-properties-and-classes-prop-types)
        -   [General Prop Types (e.g. HTML 5 props, event listeners etc.)](https://rmolinamir.github.io/typescript-cheatsheet/#general-prop-types-eg-html-5-props-event-listeners-etc)
    -   [Setting up React References (React.createRef() or useRef API)](https://rmolinamir.github.io/typescript-cheatsheet/#setting-up-react-references-reactcreateref-or-useref-api)
        -   [TypeScript & useRef](https://rmolinamir.github.io/typescript-cheatsheet/#typescript--useref)
        -   [TypeScript & React.createRef](https://rmolinamir.github.io/typescript-cheatsheet/#typescript--reactcreateref)
    -   [Setting up Event Handlers](https://rmolinamir.github.io/typescript-cheatsheet/#setting-up-event-handlers)
    -   [TypeScript and React Hooks](https://rmolinamir.github.io/typescript-cheatsheet/#typescript-and-react-hooks)
        -   [useState](https://rmolinamir.github.io/typescript-cheatsheet/#usestate)
        -   [useEffect](https://rmolinamir.github.io/typescript-cheatsheet/#useeffect)
        -   [useContext](https://rmolinamir.github.io/typescript-cheatsheet/#usecontext)
        -   [useReducer](https://rmolinamir.github.io/typescript-cheatsheet/#usereducer)
        -   [useCallback](https://rmolinamir.github.io/typescript-cheatsheet/#usecallback)
        -   [useMemo](https://rmolinamir.github.io/typescript-cheatsheet/#usememo)
        -   [useRef](https://rmolinamir.github.io/typescript-cheatsheet/#useref)
        -   [useImperativeHandle](https://rmolinamir.github.io/typescript-cheatsheet/#useimperativehandle)
        -   [useLayoutEffect](https://rmolinamir.github.io/typescript-cheatsheet/#uselayouteffect)
        -   [useDebugValue](https://rmolinamir.github.io/typescript-cheatsheet/#usedebugvalue)
        -   [Custom Hooks](https://rmolinamir.github.io/typescript-cheatsheet/#custom-hooks)
    -   [Feedback](https://rmolinamir.github.io/typescript-cheatsheet/#feedback)
    -   [Collaborators](https://rmolinamir.github.io/typescript-cheatsheet/#collaborators)
    -   [Contribute](https://rmolinamir.github.io/typescript-cheatsheet/#contribute)
...
[⬆️ Back to top](https://rmolinamir.github.io/typescript-cheatsheet/#table-of-contents)  
...
Because of the previously mentioned limitation, intersection types are less common than union types, they would be *very* hard to use on variables with “basic” levels of types. Fortunately for us, by using `interfaces` ([explained here](https://rmolinamir.github.io/typescript-cheatsheet/#interfaces)) (and other advanced types), intersection types become ***very*** useful. Let’s take a look at a more advanced example (which assumes the reader has at least basic knowledge of interfaces):
...
**NOTE:** If you want to mix **members** (not types) of a `class`, you should use the `extend` keyword instead, [explained here](https://rmolinamir.github.io/typescript-cheatsheet/#extends-keyword-interface-inheritance).
...
1.  [Export](https://rmolinamir.github.io/typescript-cheatsheet/#export)
2.  [Default Exports](https://rmolinamir.github.io/typescript-cheatsheet/#default-exports)
3.  [Import](https://rmolinamir.github.io/typescript-cheatsheet/#import)
4.  [Advanced Module Loading](https://rmolinamir.github.io/typescript-cheatsheet/#advanced-module-loading)
...
[Very similar to the optional object properties](https://rmolinamir.github.io/typescript-cheatsheet/#optional-object-properties), to define an interface property as optional, we must place a `?` character after the key name of the property when defining it (a postfix notation). Here’s an example:
...
1.  Use **discriminators** to check for instances of specific objects.
...
> A major part of software engineering is building components that not only have well-defined and consistent APIs, but are also reusable. Components that are capable of working on the data of today as well as the data of tomorrow will give you the most flexible capabilities for building up large software systems. In languages like `C#` and `Java`, one of the main tools in the toolbox for creating reusable components is generics, that is, being able to create a component that can work over a variety of types rather than a single one. This allows users to consume these components and use their own types.
...
1.  Run `tsc --init`, then modify the `tsconfig.json` file to look like this or similar:
...
1.  Webpack `webpack.config.js` file configuration to handle TypeScript:
...
React provides the reference objects types out of the box, imported from the **React** default export, from the `react` package (or as a named export as well). The name of the object type is `RefObject`, and it is essentially a [generic interface](https://rmolinamir.github.io/typescript-cheatsheet/#generic-types). Here’s the definition:
...
1.  Lastly, define a `initialState` variable if needed, and a `useReducer` hook inside the React component, then it’s good to go. The `useReducer` declaration will almost always look like this:
...
`useImperativeHandle` is **very rarely** used. This hook exposes the instantiated custom value of a React reference to parent components ([more details in `useRef`](https://rmolinamir.github.io/typescript-cheatsheet/#useref)). This means that you can setup a React reference object, customize it in any way possible, e.g. adding methods, then forward it with `React.forwardRef`. If a parent component then creates a reference then “hooks” it to the child component, the parent component will have access to the reference.

Here’s what the React team has to say about this hook:

> `useImperativeHandle` customizes the instance value that is exposed to parent components when using: - `ref`. As always, imperative code using refs should be avoided in most cases. - `useImperativeHandle` should be used with `React.forwardRef`.
...
---
Source: [typescript-cheatsheet](https://rmolinamir.github.io/typescript-cheatsheet/)