  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      <SectionHeader
        eyebrow="🧩 Practice"
        title="Problems"
        description="Choose a problem set to practice. Each set contains multiple modules with hands-on coding problems and detailed explanations."
        titleAs="h1"
      />
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-auto flex flex-wrap items-center gap-4 text-xs text-fg-subtle">
                  <span className="flex items-center gap-1">
                    ...
                    {modules.length} modules · {lessons.length} problems
                  </span>
                  <span className="flex items-center gap-1">
